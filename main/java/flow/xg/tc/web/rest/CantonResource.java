...
public class CantonResource {
    ...
    @Timed
    public ResponseEntity<Canton> createCanton(@Valid @RequestBody Canton canton) throws URISyntaxException {
    ...
    @RequestMapping(value = "/cantons",
        ...
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<Canton> updateCanton(@Valid @RequestBody Canton canton) throws URISyntaxException {
